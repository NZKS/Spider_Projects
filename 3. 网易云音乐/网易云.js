      ...
      , q = l.BufferedBlockAlgorithm = t.extend({
        ...
        mP2x: function(a) {
            var c = this.i7b
              ...
              , k = this.blockSize
              , b = j / (4 * k)
              , b = a ? u.ceil(b) : u.max((b | 0) - this.Xs4w, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
    ...
    var p = CryptoJS
      ...
      , v = d.Cipher = t.extend({
        ...
        createEncryptor: function(e, a) {
            return this.create(this.Hk7d, e, a)
        },
        createDecryptor: function(e, a) {
            return this.create(this.bsf1x, e, a)
        },
        init: function(e, a, b) {
    ...
    d.BlockCipher = v.extend({
        ...
        reset: function() {
            ...
            var a = this.cfg
              , b = a.iv
              , a = a.mode;
            if (this.Xr4v == this.Hk7d)
                var c = a.createEncryptor;
            else
                c = a.createDecryptor,
                this.Xs4w = 1;
            this.eV9M = c.call(a, this, b && b.words)
        },
        sS4W: function(a, b) {
            this.eV9M.processBlock(a, b)
        },
        og2x: function() {
...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        md1x: function() {
            for (var a = this.J8B, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.ZJ5O = d + 6) + 1), e = this.bsC1x = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        encryptBlock: function(a, b) {
            this.Fh7a(a, b, this.bsC1x, t, r, w, v, l)
        },
        decryptBlock: function(a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.Fh7a(a, c, this.bsH1x, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        },
        Fh7a: function(a, b, c, d, e, j, l, f) {
            for (var m = this.ZJ5O, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
data = '{"uid": "302065359", "type": "-1", "limit": "1000", "offset": "0", "total": "true", "csrf_token": ""}'

console.log(d(data,"010001","","0CoJUm6Qyw8W8jud"))
